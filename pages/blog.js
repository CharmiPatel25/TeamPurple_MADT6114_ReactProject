    ...
    return (
      <Meta>
        <Head>
          ...
          <meta
            name="description"
            content={this.props.blogPage.metadata.seo_description.value}
          />
          <link
            rel="icon"
            type="image/png"
            href={`${this.props.globals.header.metadata.favicon.imgix_url}?w=32`}
            sizes="32x32"
          />
          <link
            rel="icon"
            type="image/png"
            href={`${this.props.globals.header.metadata.favicon.imgix_url}?w=16`}
            sizes="16x16"
          />
        </Head>
        <Header
          header={this.props.globals.header}
          nav={this.props.globals.nav}
        />
        <Blog blogs={this.props.blogs} blog={this.props.blog}></Blog>
        <Footer
          footer={this.props.globals.footer}
          social={this.props.globals.social}
